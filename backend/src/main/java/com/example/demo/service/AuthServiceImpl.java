...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse authenticate(LoginRequest loginRequest) {
        ...
        if (userOptional.isPresent()) {
            ...
            if (user.getPassword().equals(loginRequest.getPassword())) {
                return new LoginResponse(true, "Login successful", user.getRole(), user.getEmail(), user.getName(), user.getSignupDate(), user.getId());
            }
        }
    ...
    public LoginResponse register(SignupRequest signupRequest) {
        ...
        return new LoginResponse(true, "Registration successful", newUser.getRole(), newUser.getEmail(), newUser.getName(), newUser.getSignupDate(), newUser.getId());
    }
    ...
    public LoginResponse processForgotPassword(ForgotPasswordRequest request) {
        ...
        if (userOptional.isPresent()) {
            return new LoginResponse(true, "Email verified. You can now reset your password.", null, request.getEmail(), null, null, null);
        }
        return new LoginResponse(false, "No account found with this email.", null, null, null, null, null);
    }
    ...
    public LoginResponse resetPassword(ResetPasswordRequest request) {
        ...
        if (userOptional.isPresent()) {
            ...
            return new LoginResponse(true, "Password updated successfully.", null, user.getEmail(), user.getName(), user.getSignupDate(), user.getId());
        }
        return new LoginResponse(false, "Could not reset password. User not found.", null, null, null, null, null);
    }
}
